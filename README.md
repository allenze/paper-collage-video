...
当前公开稳定版本为 [`0.8.0`](https://github.com/cyberlesterr/paper-collage-video/releases/tag/v0.8.0)，仓库中正在验证的开发版为 `0.14.0-dev.1`。新协议加入节奏故事板、注册组合模式、本地关键帧、持久显隐/短暂强调/声音共源事件、7 种动画纸张转场与意图路由、人物/拓扑/机构/说明图语义契约、真实生成尝试账本，以及资产/组合双质量门；功能和协议仍可能在 `1.0.0` 前调整。
