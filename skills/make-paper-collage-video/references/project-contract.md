...
| `storyboard.json` | Approved schema-v8 beat treatments and intent-routed scene boundaries plus compiler-owned plans, multidimensional style-proof coverage, sheet plans, proof bindings, and directing fingerprints |
| `project.json` | Creative Plan v2 budgets and v8 Remotion execution tree |
